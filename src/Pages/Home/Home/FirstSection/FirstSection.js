...
const FirstSection = () => {
    ...
    fetch(url, {
      ...
      .then((imgData) => {
        if (imgData.success) {
          ...
          fetch("https://social-media-server-pi-opal.vercel.app/post", {
            method: "POST",
            headers: {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: `url("https://images.unsplash.com/photo-1625225230517-7426c1be750c?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80")`,
      }}
    >
